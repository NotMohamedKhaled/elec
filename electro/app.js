...
// // Allow Express to handle standard submitted form data
// app.use(express.urlencoded({ limit: '50mb', extended: true }));
app.use(express.json());

app.use(
  express.static(path.join(__dirname, '../ElectroHub'), {
...
app.get('*', (req, res) => {
  res.sendFile(path.join(__dirname, '../ElectroHub/home.html'));
});
